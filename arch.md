...
```bash
pacstrap -K /mnt networkmanager network-manager-applet iwd dhcpcd openssh man-db man-pages man-pages-zh_cn zsh git neovim
```
...
| 软件包 | 安装                                                                                        | 备注 |
| ------ | ------------------------------------------------------------------------------------------- | ---- |
| 基本   | pacman -S terminus-font noto-fonts noto-fonts-cjk noto-fonts-emoji                          |      |
| 常用   | pacman -S ttf-sarasa-gothic ttf-fira-code ttf-jetbrains-mono                                |      |
| Nerd   | pacman -S ttf-firacode-nerd ttf-jetbrains-mono-nerd awesome-terminal-fonts otf-font-awesome |      |
